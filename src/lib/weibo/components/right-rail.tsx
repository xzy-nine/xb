    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <Card className="py-4">
        <CardHeader className="px-4">
          ...
          <CardDescription>原仓库为nnecec/xb，这里是本特色分支的反馈问题页面</CardDescription>
        </CardHeader>
        <CardContent className="text-muted-foreground flex flex-col gap-3 px-4 text-sm">
          <a
            href="https://github.com/xzy-nine/xb/issues"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:bg-accent/60 hover:text-foreground focus-visible:ring-ring/50 relative flex items-center gap-2 rounded-md px-2 py-1.5 transition-colors focus-visible:ring-2 focus-visible:outline-none"
          >
            <CircleDot className="h-4 w-4" />
            <span>反馈问题</span>
            <span className="bg-primary text-primary-foreground absolute -top-1 -right-1 rounded px-1 py-0.5 text-xs font-medium">
              特色分支
            </span>
          </a>
          <a
            href="https://github.com/xzy-nine/xb"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:bg-accent/60 hover:text-foreground focus-visible:ring-ring/50 relative flex items-center gap-2 rounded-md px-2 py-1.5 transition-colors focus-visible:ring-2 focus-visible:outline-none"
          >
